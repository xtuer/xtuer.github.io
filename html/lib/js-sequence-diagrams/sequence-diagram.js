...
if (typeof Snap != 'undefined') {
  ...
  var LINE = {
    'stroke': '#999',
    'stroke-width': 1.3, // BUG TODO This gets set as a style, not as a attribute. Look at  eve.on("snap.util.attr"...
    'fill': 'none'
  };
  ...
  _.extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    setupPaper: function(container) {
      ...
      a[ARROWTYPE.FILLED] = arrow.marker(0, 0, 5, 5, 5, 2.5)
       .attr({id: 'markerArrowBlock', fill: '#999'});
      ...
      a[ARROWTYPE.OPEN] = arrow.marker(0, 0, 9.6, 16, 9.6, 8)
       .attr({markerWidth: '4', id: 'markerArrowOpen', fill: '#999'});
    },
