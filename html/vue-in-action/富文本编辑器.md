基于 TinyMCE 实现了富文本组件 `RichText`:

* 支持粘贴从 word 复制的图片
* 支持上传文件、图片、视频和音频
* 如果想支持粘贴 word 的文本格式，修改 paste_as_text 为 false
* 支持自定义工具栏
* 支持普通模式和 inline 模式
* 使用 v-model 双向绑定数据

<img src="img/rich-text.png" width=617>
...
<template>
    <div class="about">
        <RichText v-model="html" :min-height="300" inline/>
...
下面是 RichText 的源码，具体的实现可请参考 [Vue 中使用 TinyMCE](https://www.qtdebug.com/fe-vue-tinymce/):
